function [time]=parallelprocessingonline(FileName,poolSize,numHours,size)
...
%% Parallel Analysis
    ...
    PoolSize = poolSize ; % define the number of threads to use in parallel
    ...
    T4 = toc;
    Size=size;
    parfor idx = 1:Size  % size(Data2Process,1)
